...
腾讯WX的面试题涵盖了Vue、webpack、浏览器事件循环、hybrid开发、文件上传等核心技术，以及二叉树、数组算法等常见算法题。

**详细题目：** 查看 [腾讯WX面试题集锦](./腾讯WX面试题集锦.md)
...
小米的面试题以手写实现为主，涵盖JavaScript核心API、Vue/React原理、算法题等。

**详细题目：** 查看 [小米面试题集锦](./小米面试题集锦.md)
